# MLOps Iris ML API — Лабораторна робота 2
...
├── assets/
│   ├── health.png          # Скріншот /health
│   └── predict.png         # Скріншот /predict
...
![health endpoint](assets/Screenshot_1.png)

### POST `/predict` — класифікація квітки Iris

![predict endpoint](assets/Screenshot_2.png)
